...
/**
 * Placeholder for Typing Race — this game isn't offered for selection
 ...
 * export name TypingRaceGame and this file's path), then flip comingSoon to
 * false for this game in lib/games.ts. Nothing else needs to change.
 */
export function TypingRaceGame({}: { matchId: string; roomCode: string; opponentId: string }) {
  return (
