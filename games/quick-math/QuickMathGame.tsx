...
/**
 * Placeholder for Quick Math — this game isn't offered for selection
 ...
 * export name QuickMathGame and this file's path), then flip comingSoon to
 * false for this game in lib/games.ts. Nothing else needs to change.
 */
export function QuickMathGame({}: { matchId: string; roomCode: string; opponentId: string }) {
  return (
