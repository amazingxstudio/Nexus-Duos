...
/**
 * Placeholder for Word Chain — this game isn't offered for selection
 ...
 * export name WordChainGame and this file's path), then flip comingSoon to
 * false for this game in lib/games.ts. Nothing else needs to change.
 */
export function WordChainGame({}: { matchId: string; roomCode: string; opponentId: string }) {
  return (
