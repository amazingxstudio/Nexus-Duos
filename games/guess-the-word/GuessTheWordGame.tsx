...
/**
 * Placeholder for Guess The Word — this game isn't offered for selection
 ...
 * export name GuessTheWordGame and this file's path), then flip comingSoon to
 * false for this game in lib/games.ts. Nothing else needs to change.
 */
export function GuessTheWordGame({}: { matchId: string; roomCode: string; opponentId: string }) {
  return (
