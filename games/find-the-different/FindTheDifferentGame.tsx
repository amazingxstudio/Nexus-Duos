...
/**
 * Placeholder for Find The Different — this game isn't offered for selection
 ...
 * export name FindTheDifferentGame and this file's path), then flip comingSoon to
 * false for this game in lib/games.ts. Nothing else needs to change.
 */
export function FindTheDifferentGame({}: { matchId: string; roomCode: string; opponentId: string }) {
  return (
